...
namespace ADD_NETCore_Prototype.Migrations
{
    ...
    public partial class IdentitySchema : Migration
    {
        ...
        {
            migrationBuilder.DropForeignKey(name: "FK_Pets_Users_OwnerId", table: "Pets");
        ...
        {
            migrationBuilder.DropForeignKey(name: "FK_Pets_AspNetUsers_OwnerId", table: "Pets");
            ...
            migrationBuilder.DropForeignKey(name: "FK_Tasks_AspNetUsers_UserId", table: "Tasks");
